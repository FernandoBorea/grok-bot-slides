...
| Grok Bot for Engineering            | `grok-bot-for-engineering`              |      6 |
...
Las seis plantillas incluyen 21 slides con componentes independientes, guías móviles y preguntas iniciales editables. Engineering conserva su recorrido de seis slides y abre con **«¿Quiénes han utilizado Grok bot?»**, con opciones Sí y No. Cada uno de los demás decks parte de una bienvenida, un concepto y un ejercicio. Los metadatos viven en el `deck.ts` de cada carpeta; `src/decks/index.ts` establece el orden de la biblioteca.

La vista del presentador muestra la slide 16:9, miniaturas, navegación por teclado, pantalla completa, guía y controles de participación. El botón de sol/luna cambia solo las slides y sus miniaturas entre claro y oscuro; la preferencia se guarda por deck en este navegador. Las preguntas y sus resultados aparecen debajo del lienzo, dentro del bloque proyectado, también en pantalla completa. La vista del público muestra texto pensado para leer en el teléfono, su avatar y la pregunta de la slide que está leyendo. Tiene navegación anterior/siguiente y un botón **Ir al presentador** para volver al punto en vivo sin que los cambios interrumpan la lectura. No necesita reproducir el diseño de la pantalla proyectada.
...
4. Envía una respuesta. Los resultados se actualizan automáticamente debajo de la slide. El botón **Mostrar en móviles** permite publicarlos también en los teléfonos; una respuesta puede actualizarse mientras la pregunta siga abierta.
